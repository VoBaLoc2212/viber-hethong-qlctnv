          ...
          <CardContent>
            <div className="grid gap-3 sm:grid-cols-3 sm:gap-4">
              <div className="rounded-lg border border-border/50 bg-secondary/30 p-4">
                ...
                <p className="mt-1 text-xs leading-5 text-muted-foreground">Phân quyền theo role tài chính.</p>
              </div>
              <div className="rounded-lg border border-border/50 bg-secondary/30 p-4">
                <div className="mb-3 inline-flex h-8 w-8 items-center justify-center rounded-md bg-primary/10">
                ...
                <p className="mt-1 text-xs leading-5 text-muted-foreground">Truy vết hành động theo correlation.</p>
              </div>
              <div className="rounded-lg border border-border/50 bg-secondary/30 p-4">
                <div className="mb-3 inline-flex h-8 w-8 items-center justify-center rounded-md bg-primary/10">
