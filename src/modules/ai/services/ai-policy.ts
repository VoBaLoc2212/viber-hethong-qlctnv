...
export const AI_POLICY_MATRIX: readonly AiPolicyRule[] = [
  {
    ...
    keywords: /quy\s*trinh|huong\s*dan|help|chinh\s*sach|policy|how\s*to|lam\s*sao|quyen|vai\s*tro|role|permission|co\s*the\s*lam\s*gi/i,
    intents: ["GUIDANCE"],
    allowedRoutesByRole: {
      EMPLOYEE: ["SERVICE", "RAG"],
      MANAGER: ["SERVICE", "RAG"],
      ACCOUNTANT: ["SERVICE", "RAG"],
      FINANCE_ADMIN: ["SERVICE", "RAG"],
      AUDITOR: ["SERVICE", "RAG"],
    },
    defaultRoutes: ["SERVICE", "RAG"],
    scopeByRole: {},
