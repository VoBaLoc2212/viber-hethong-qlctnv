...
import { PieChart, Plus, Building2, TrendingUp, AlertTriangle } from "lucide-react";
import { useGetDepartments, useCreateDepartment, useGetTransactions } from "@workspace/api-client-react";
...
export default function Budgets() {
  ...
  // Fetch transactions to calculate spent amounts per department. Limit large enough to get a rough aggregate.
              ...
              <CardContent className="p-6">
                ...
                <div className="space-y-2">
                  ...
                  <Progress 
                    value={percentage} 
                    className="h-2" 
                    indicatorClassName={isOverBudget ? "bg-destructive" : isWarning ? "bg-yellow-500" : "bg-primary"}
                  />
                </div>
              </CardContent>
            </Card>
